...
function ItemImageOrIcon({ item, className, fallbackSize = "20px" }) {
    ...
    if (imgError || !itemImage) {
        const fallbackEmoji = item.icon || (item.category === "Alchemical-Herbs" ? "🌿" : item.category === "Food_Berries" ? "🫐" : item.category === "Food_Fruits" ? "🍎" : item.category === "Food_Vegetables" ? "🥦" : "📦");
                                ...
                                <div className="item-details-panel-modern">
                                    ...
                                    <div className="details-footer-modern">
                                        ...
                                        <div className="details-actions-modern">
                                            {(selectedItem.category === "Alchemical-Herbs" || selectedItem.category === "Food_Berries" || selectedItem.category === "Food_Fruits" || selectedItem.category === "Food_Cooked" || selectedItem.category === "Food_Vegetables" || selectedItem.satietyRestore !== undefined || selectedItem.hpRestore !== undefined) && (
