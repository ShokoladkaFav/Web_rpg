...
function GameMap({ onClose, playerLocationId, onSelectLocation }) {
    ...
    const settlements = [
        ...
        { id: "village1", name: "Слітденн", x: 34, y: 60 },
        { id: "capital", name: "Столиця 'Емберхолд'", x: 30.5, y: 66 },
        { id: "town_1", name: "Мітгейт", x: 33, y: 90 },
        { id: "desert_village1", name: "Бран", x: 24.5, y: 66 },
        { id: "desert_village2", name: "Доункрест", x: 20, y: 74 },
        { id: "desert_village3", name: "Стілмедоу", x: 19, y: 55 },
        { id: "desert_village4", name: "Елдерхенд", x: 12, y: 61 },
        { id: "desert_village5", name: "Шіммерспайр", x: 19, y: 55 },
        { id: "desert_destroy", name: "Руїни старої фортеці", x: 6, y: 58 },
        { id: "desert_town", name: "Фарвінд", x: 8, y: 48 },
        { id: "town_2", name: "Мідспайр", x: 17.5, y: 38 },
        { id: "elf_capital", name: "Велике Дерево", x: 19.7, y: 34 },
        { id: "port_town_1", name: "Бріджмаут", x: 39, y: 37 },
        { id: "port_town_2", name: "Фолфорд", x: 55.5, y: 41.5 },
        { id: "town_3", name: "Мадвінд", x: 91.5, y: 39.5 },
        { id: "dwarf_capital", name: "Фортеця дворфів", x: 77.7, y: 53 },
        { id: "village2", name: "Шіммерглен", x: 59.5, y: 58 },
        { id: "port_town_3", name: "Віндхем", x: 55, y: 74.5 },
        { id: "village3", name: "Шрауд'ярд", x: 68.5, y: 64.6 },
        { id: "port_town_3", name: "Рейвенхоллоу", x: 76.8, y: 69 },
        { id: "port_town_4", name: "Амбервік", x: 89.4, y: 69 },
        { id: "village4", name: "Мадфрост", x: 74.5, y: 39 },
    ];
